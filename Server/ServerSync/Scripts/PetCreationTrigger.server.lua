...
local InitPetCreationRemoteEvent = RemoteEvent.FirstTimePlayed.InitPetCreation :: RemoteEvent
local triggerTagName = "PetCreationTrigger"
...
local function onPartTouch(trigger: BasePart, otherPart: BasePart)
	...
	InitPetCreationRemoteEvent:FireClient(player)
end
