--ZonesPlus
--Scripted by ForeverHD, https://devforum.roblox.com/t/zoneplus-v320-construct-dynamic-zones-and-effectively-determine-players-and-parts-within-their-boundaries/1017701
--ZonesPlus operates under an MIT Free Use License.
...
local Signal = require(script.Parent.ZoneSignal)
local ZonePlusReference = require(script.Parent.ZonePlusReference)
local referenceObject = ZonePlusReference.getObject()
local zoneControllerModule = script.Parent.ZoneController
local trackerModule = script.Parent.ZoneControllerFolder.Tracker
local collectiveWorldModelModule = script.Parent.ZoneControllerFolder.CollectiveWorldModel
